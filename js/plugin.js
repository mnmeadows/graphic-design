...
var video = [
	new VideoDataObj ([
		[],
		'<iframe width="100%" height="245px" src="https://www.youtube.com/embed/X78BgiYezsk" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="d-flex flex-fill"></iframe><br>A vlog about a trip I took across Europe with my band. Edited in Adobe Premiere Elements.',
		'poster-europe.png'
	]),
	new VideoDataObj ([
		['Theatre-Vlog.mp4'],
		'A vlog highlighting a year in a theatre company. Edited in Adobe Premiere Elements.',
		'poster-theatre.png'
	]),
	new VideoDataObj ([
		['SurveyFinal.mp4'],
		"A mock video trailer announcing the shows for a theatre's upcoming season. Edited in Adobe Premiere Pro.",
		'poster-season.png'
	]),
	new VideoDataObj ([
		[],
		'<iframe width="100%" src="https://www.youtube.com/embed/tTF4YwCar9A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br>My project for National History Day about Louis Armstrong. Edited in Adobe Premiere Elements.',
		'poster-history.png'
	]),
];
var animations = [
